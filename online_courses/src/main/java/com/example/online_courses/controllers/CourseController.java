...
public class CourseController {
    ...
    public String coursePostAdd(@RequestParam String name, @RequestParam String description, @RequestParam LocalDateTime start_time, @RequestParam LocalDateTime end_time, Model model) {
